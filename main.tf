module "master" {
  ...
  swarm_traefik_dashboard_fqdn  = var.traefik_dashboard_fqdn
  swarm_traefik_dashboard_login = var.traefik_dashboard_login
  # Portainer (optional)
  swarm_portainer_enabled   = var.portainer_enabled
  swarm_portainer_fqdn      = var.portainer_fqdn
  swarm_portainer_edge_fqdn = var.portainer_edge_fqdn
}
...
module "loadbalancer" {
  ...
  loadbalancer_hostname_names          = [var.lb_host_name, var.traefik_dashboard_fqdn, var.portainer_fqdn, var.portainer_edge_fqdn]
